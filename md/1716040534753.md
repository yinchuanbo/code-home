---
title: "Emoji Toggle"
date: 2024-05-18T21:55:34+08:00
type: "pc"
...
input {
  ...
  transition: background-color var(--trans-dur) var(--trans-timing1), color var(
        --trans-dur
      ) var(--trans-timing1);
}
...
.switch__emoji:before {
  ...
  box-shadow: -0.25em -0.25em 0.25em #c29d0a inset, 0.1875em 0.1875em 0.25em
      #f9e286 inset;
}
.switch__emoji:after {
...
.switch__emoji-mouth {
  background-image: radial-gradient(
      ...
      #f5463d 33%,
      rgba(245, 70, 61, 0) 35%
    ), radial-gradient(100% 100% at 75% 113%, black 26%, rgba(0, 0, 0, 0) 35%),
...
.switch__input {
  ...
  box-shadow: 0.0625em 0.0625em 0.0625em white inset, -0.0625em -0.0625em
    ...
    0 0 0 0.125em hsl(var(--hue), 10%, 90%) inset, 0.25em 0.25em 0.125em rgba(
        0,
        0,
        0,
        0.3
      ) inset, 0.0625em 0.0625em 0.0625em rgba(0, 0, 0, 0.3);
  cursor: pointer;
  display: block;
  width: 2.5em;
  height: 1.5em;
...
@media (prefers-color-scheme: dark) {
  ...
  .switch__input {
    ...
    box-shadow: 0.0625em 0.0625em 0.0625em hsl(var(--hue), 10%, 25%) inset, -0.0625em -0.0625em
        0.0625em hsl(var(--hue), 10%, 20%) inset,
      0 0 0 0.125em hsl(var(--hue), 10%, 30%) inset, 0.25em 0.25em 0.125em rgba(
          0,
          0,
          0,
          0.3
