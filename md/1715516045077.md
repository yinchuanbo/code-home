---
title: "CSS-only direction-aware hover effect"
date: 2024-05-12T20:14:05+08:00
type: "pc"
creator: "yinhao"
---
...
<header>
  ...
  <p>
    Comes with a Sass @mixin so that you can quickly modify the number of
    columns and items.
  </p>
  <p>
    Also, you can <strong>resize</strong> the window. It keeps working when grid
    changes.
  </p>
</header>
<ul class="grid">
